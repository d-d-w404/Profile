...
permalink: /working/sccn-graduate-research
venue: "Swartz Center for Computational Neuroscience (SCCN), UC San Diego"
date: 2025-07-01
...
- Building a Python-based real-time EEG processing pipeline inspired by REST, integrating ORICA, ASR, IIR filtering, and ICLabel
- Designing pseudo-real-time validation protocols to ensure cross-platform consistency between MATLAB and Python implementations
- Developing online stress classification experiments on continuous-stress EEG datasets
